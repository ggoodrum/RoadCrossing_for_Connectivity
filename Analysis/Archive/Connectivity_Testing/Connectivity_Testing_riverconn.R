...
# --------------------------------------------------------------------- #
# 03. Logan River testing
# ---------------------------------------------------------------------

# Set inputs
raw.data            <- 'Stream_LR.csv'
raw.fields          <- c('From_Node', 'To_Node', 'Length_km', 'UID', 'BARRIER_GROUP', 'Pass_WDFG')

attributes.edgeType <- 'BARRIER_GROUP'
attributes.edge     <- c('UID', 'BARRIER_GROUP', 'Pass_WDFG')
